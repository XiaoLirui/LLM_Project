...
class Index:
    ...
    def fit(self, docs):
        ...
        for field in self.text_fields:
            ...
            filtered_docs = [doc for doc, text in zip(docs, texts) if text]
            texts = [text for text in texts if text]

            # print(f"Field: {field}, Length of texts: {len(texts)}, Length of docs: {len(filtered_docs)}")


            if not texts:
                print(f"No valid texts for field '{field}'. Skipping this field.")
                continue
            ...
            try:
                ...
                print(f"Error occurred for field '{field}': {e}")
                print(f"Failed texts: {texts}")
